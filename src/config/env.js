...
const env = {
  ...
  daraja: {
    ...
    c2bShortCode: process.env.DARAJA_C2B_SHORT_CODE || process.env.DARAJA_SHORT_CODE || '',
    stkShortCode: process.env.DARAJA_STK_SHORT_CODE || process.env.DARAJA_SHORT_CODE || '',
